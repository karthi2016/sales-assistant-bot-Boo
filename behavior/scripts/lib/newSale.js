...
/*
    ...
    */
exports.checkSalesCompany = (client) => client.createStep({
    extractInfo() {
...
exports.checkSalesAmount = (client) => client.createStep({
    extractInfo() {
...
exports.handleSalesConfirmation = (client) => client.createStep({
    satisfied() {
        return false
    },
